// from http://git.chise.org/gitweb
// merge into a single require.js AMD
  ...
  if(kage.kShotai == kage.kMincho){
    ...
    case 1:
      if(a3 == 4){
        ...
        cdDrawCurve(kage, polygons, tx1, ty1, x2, y2, x2 - kage.kMage * (((kage.kAdjustTateStep + 4) - Math.floor(a2 / 1000)) / (kage.kAdjustTateStep + 4)), y2, 1 + (a2 - a2 % 1000), 14);
      }
      else{
    ...
    case 6:
      if(a3 == 4){
        ...
        cdDrawCurve(kage, polygons, tx1, ty1, x4, y4, x4 - kage.kMage, y4, 1, 14);
      }
      else if(a3 == 5){
    ...
    case 6:
      if(a3 == 5){
         ...
         */
				cdDrawLine(kage, polygons, x1, y1, x2, y2, a2, a3);
				//cdDrawLine(kage, polygons, x2, y2, x3, y3, a2, a3);
				//cdDrawLine(kage, polygons, x2, y2, x3, y3, a2, a3);
				//cdDrawCurve(kage, polygons, x1, y1, (x2+x3)/2, (y2+y3)/2, x4, y4,  a2, a3);
				cdDrawCurve(kage, polygons, x2, y2, x3, y3, x4, y4,  a2, a3);
...
function Polygons(){
  ...
  return { Kage:Kage, Polygons: Polygons} ;
});